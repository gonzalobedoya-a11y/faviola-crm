      ...
      <section className="overflow-hidden rounded-xl border border-brand/25 bg-surface-raised shadow-elevation-1">
        <div className="grid gap-0 lg:grid-cols-[1fr_340px]">
          ...
          <Link
            href="/academia"
            target="_blank"
            className="relative min-h-52 overflow-hidden bg-surface-sunken lg:min-h-full"
          ...
          >
            ...
            <span className="absolute bottom-3 right-3 rounded-full border border-brand/30 bg-surface-raised px-3 py-1.5 text-xs font-semibold text-brand-deep shadow-elevation-2">
